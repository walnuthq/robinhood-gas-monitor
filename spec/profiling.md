...
[profiling-a-deployed-contract.md](profiling-a-deployed-contract.md) works this
through end to end for a contract already deployed on a public chain: recovering
verified sources, reproducing the deployed bytecode, and checking the recompile
before trusting the line numbers it produces.
